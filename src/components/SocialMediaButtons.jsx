...
const SocialMediaButtons = () => {
  const socialLinks = [
    {
      name: "Facebook",
      icon: <ImFacebook className="text-xl" />,
  ...
  return (
    <div className="fixed top-1/2 left-2 transform -translate-y-1/2 z-50 flex flex-col gap-4">
      {socialLinks.map((social, index) => (
        <a
          ...
          className={`${social.color} text-white rounded-full p-4 shadow-lg transition-all duration-300 transform hover:scale-110 flex items-center justify-center`}
