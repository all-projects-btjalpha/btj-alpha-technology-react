...
const technologies = [
  { name: "Angular", icon: "/images-removebg-preview.png" },
  { name: "ASP.net", icon: "/asp.net-removebg-preview.png" },
  { name: "React", icon: "/react-removebg-preview.png" },
  { name: "Shopify", icon: "/shopify-removebg-preview.png" },
  { name: "MySQL", icon: "/mysql-removebg-preview.png" },
  { name: "Azure", icon: "/azure-removebg-preview.png" },
  { name: "Google Cloud", icon: "/gcp-removebg-preview.png" },
  { name: "WordPress", icon: "/wordpress-removebg-preview.png" },
  { name: "HTML", icon: "/html-removebg-preview.png" },
  { name: "JavaScript", icon: "/js-removebg-preview.png" },
  { name: "CodeIgniter", icon: "/codeigniter-removebg-preview.png" },
  { name: "CSS", icon: "/css-removebg-preview.png" },
  { name: "Photoshop", icon: "/ps_1-removebg-preview.png" },
  { name: "Illustrator", icon: "/AI-removebg-preview.png" },
  { name: "Figma", icon: "/figma-removebg-preview.png" },
  { name: "Bootstrap", icon: "/Bootstrap-removebg-preview.png" },
];
