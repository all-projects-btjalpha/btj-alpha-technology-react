...
function Flutter() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Flutter offers fast development, native performance, expressive UI, single codebase for multiple platforms, and excellent developer experience."
    },
    {
      question: "Is Flutter suitable for enterprise apps?",
      answer: "Yes, Flutter is suitable for enterprise applications with its performance, security, and scalability features."
    }
  ];
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  <div className="relative">
                    {/* Large Flutter Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <SiFlutter className="text-9xl text-[#02569b]" />
                    </div>
                  </div>
