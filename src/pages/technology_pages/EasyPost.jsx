  ...
  const faqs = [
    {
      ...
      answer: "EasyPost is a shipping API platform that provides rate calculation, label generation, and tracking services across multiple carriers."
    },
    {
      question: "Which carriers does EasyPost support?",
      answer: "EasyPost integrates with major carriers including USPS, UPS, FedEx, DHL, Canada Post, and many regional carriers."
    },
    {
      question: "How long does shipping integration take?",
      answer: "Basic shipping integration typically takes 2-3 weeks, with complex multi-carrier solutions taking 4-6 weeks."
    }
  ];
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  <div className="relative">
                    {/* Large Truck Icon with gradient background */}
                    <div className="bg-gradient-to-br from-orange-100 to-red-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaTruck className="text-9xl text-[#ff6b35]" />
                    </div>
                  </div>
