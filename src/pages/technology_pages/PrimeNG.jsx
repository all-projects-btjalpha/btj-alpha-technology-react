...
function PrimeNG() {
  ...
  const faqs = [
    {
      question: "What is PrimeNG?",
      answer: "PrimeNG is a rich set of UI components for Angular applications, offering 80+ components with Material Design themes."
    },
    {
      question: "Why use PrimeNG?",
      answer: "PrimeNG offers pre-built, customizable UI components that accelerate development and ensure consistent, professional user interfaces."
    },
    {
      question: "Which platforms does PrimeNG support?",
      answer: "PrimeNG supports Angular applications and works with modern web browsers and mobile devices."
    }
  ];
                ...
                <div className="relative">
                  <div className="relative">
                    ...
                    <div className="bg-gradient-to-br from-blue-100 to-cyan-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaCode className="text-9xl text-[#007ad9]" />
                    </div>
                  </div>
