  ...
  const faqs = [
    {
      ...
      answer: "HTML5 is the latest version of Hypertext Markup Language with new semantic elements, APIs, and multimedia capabilities."
    },
    {
      question: "Why use HTML5?",
      answer: "HTML5 offers better structure, native multimedia support, improved accessibility, and enhanced SEO capabilities."
    },
    {
      question: "Is HTML5 backward compatible?",
      answer: "HTML5 is designed to be backward compatible with older browsers, though some features may require polyfills."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* HTML5 Logo Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large HTML5 Icon with gradient background */}
                    <div className="bg-gradient-to-br from-orange-100 to-red-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaHtml5 className="text-9xl text-[#e34f26]" />
                    </div>
                  </div>
                  ...
                  <div className="absolute -bottom-10 -left-10 bg-white p-4 rounded-full shadow-lg animate-bounce delay-200">
                    <FaSearch className="text-3xl text-[#10B981]" />
                  </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#fb9c24] to-[#ff8c00] relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Build Modern Web Pages with HTML5?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Partner with us to leverage the power of HTML5 for your next project.
          </p>
          <button
            onClick={openForm}
