...
function SyncFusion() {
  ...
  const faqs = [
    {
      question: "What is SyncFusion?",
      answer: "SyncFusion is a comprehensive suite of UI components and development tools for building modern web and desktop applications."
    },
    {
      question: "Why use SyncFusion components?",
      answer: "SyncFusion offers pre-built, customizable UI components that accelerate development and ensure consistent, professional user interfaces."
    },
    {
      question: "Which platforms does SyncFusion support?",
      answer: "SyncFusion supports web applications (JavaScript, Angular, React), desktop applications (.NET), and mobile development."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-right">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Build enterprise-grade applications with SyncFusion comprehensive UI component suite. Our developers create professional, scalable solutions using SyncFusion powerful development tools.
              </p>
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* SyncFusion Logo Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large SyncFusion Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaCode className="text-9xl text-[#3278e4]" />
                    </div>
                  </div>
