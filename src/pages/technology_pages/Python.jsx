  ...
  const faqs = [
    {
      ...
      answer: "Python is a high-level, interpreted programming language known for its simplicity, readability, and versatility across multiple domains."
    },
    {
      question: "Why use Python?",
      answer: "Python offers simplicity, readability, extensive libraries, and versatility for web development, AI/ML, data science, automation, and more."
    },
    {
      question: "Is Python suitable for beginners?",
      answer: "Yes, Python is considered one of the best languages for beginners due to its simple syntax and readability."
    }
  ];
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  <div className="relative">
                    {/* Large Python Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-cyan-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaPython className="text-9xl text-[#3776ab]" />
                    </div>
                  </div>
                  ...
                  <div className="absolute -bottom-10 -left-10 bg-white p-4 rounded-full shadow-lg animate-bounce delay-200">
                    <FaBrain className="text-3xl text-[#10B981]" />
                  </div>
