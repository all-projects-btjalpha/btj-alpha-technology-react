...
function Highcharts() {
  ...
  const faqs = [
    {
      question: "What is Highcharts?",
      answer: "Highcharts is a popular JavaScript charting library for creating interactive data visualizations and dashboards."
    },
    {
      question: "Which chart types does Highcharts support?",
      answer: "Highcharts supports over 60 chart types including line, bar, pie, area, scatter, and 3D charts."
    },
    {
      question: "How long does chart development take?",
      answer: "Basic chart implementation typically takes 1-2 weeks, with complex dashboards taking 3-4 weeks."
    }
  ];
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  <div className="relative">
                    {/* Large Chart Icon with gradient background */}
                    <div className="bg-gradient-to-br from-green-100 to-emerald-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaChartBar className="text-9xl text-[#13a35e]" />
                    </div>
                  </div>
