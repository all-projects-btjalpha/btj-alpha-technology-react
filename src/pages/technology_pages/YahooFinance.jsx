...
import {
  FaChartLine, FaShieldAlt, FaServer, FaRocket, FaLayerGroup,
  FaCheckCircle, FaChevronDown, FaChevronUp, FaClock, FaUsers,
  FaLaptop, FaSync, FaChartBar, FaTools, FaCogs, FaMobileAlt, FaTimes
} from "react-icons/fa";
...
function YahooFinance() {
  ...
  const financeFeatures = [
    {
      icon: <FaChartLine className="text-5xl text-[#720e9e]" />,
      title: "Financial Data",
      description: "Access to real-time and historical financial market data and analytics."
    },
    {
      icon: <FaShieldAlt className="text-5xl text-[#720e9e]" />,
      title: "Data Security",
      description: "Secure access to financial data with proper authentication and compliance."
    },
    {
      icon: <FaMobileAlt className="text-5xl text-[#720e9e]" />,
      title: "API Integration",
      description: "Easy integration with Yahoo Finance and Quandl APIs for financial data."
    },
    {
      icon: <FaChartBar className="text-5xl text-[#720e9e]" />,
      title: "Market Analytics",
      description: "Comprehensive market analysis tools and financial indicators."
    },
    {
      icon: <FaCogs className="text-5xl text-[#720e9e]" />,
      title: "Custom Solutions",
      description: "Tailored financial data solutions for specific business requirements."
    },
    {
      icon: <FaLayerGroup className="text-5xl text-[#720e9e]" />,
      title: "Multi-Source Data",
      description: "Integration with multiple financial data providers and sources."
    }
  ];
  ...
  const financeServices = [
    {
      ...
      description: "Integrating Yahoo Finance, Quandl, and Alpha Vantage APIs for financial data."
    },
    {
      icon: <FaChartBar className="text-5xl text-[#10B981]" />,
      title: "Market Analysis Tools",
      description: "Building financial analysis dashboards and market monitoring solutions."
    },
    {
      icon: <FaServer className="text-5xl text-[#8B5CF6]" />,
      title: "Data Processing",
      description: "Implementing financial data processing and analysis pipelines."
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: "Access to current market data and financial information."
    },
    {
      icon: <FaRocket className="text-5xl text-[#fb9c24]" />,
      title: "Fast Integration",
      description: "Quick setup with comprehensive financial data APIs."
    },
    {
      icon: <FaShieldAlt className="text-5xl text-[#10B981]" />,
      title: "Reliable Sources",
      description: "Trusted financial data providers with accurate market information."
    }
  ];

  const whyChooseUs = [
    {
      icon: <FaUsers className="text-5xl text-[#720e9e]" />,
      title: "Financial Experts",
      description: "Specialists with experience in financial data integration and analysis."
    },
    {
      icon: <FaChartBar className="text-5xl text-[#10B981]" />,
      title: "Best Practices",
      description: "Following industry best practices for financial data implementation."
    },
    {
      icon: <FaClock className="text-5xl text-[#fb9c24]" />,
      title: "On-Time Delivery",
      description: "Rapid implementation ensuring timely financial data solutions."
    },
    {
      icon: <FaCheckCircle className="text-5xl text-[#8B5CF6]" />,
      title: "Quality Assurance",
      description: "Comprehensive testing and validation of financial data systems."
    }
  ];

  const faqs = [
    {
      question: "What financial data sources do you work with?",
      answer: "We specialize in Yahoo Finance, Quandl, and Alpha Vantage API integration for financial market data."
    },
    {
      question: "How accurate is the financial data?",
      answer: "We work with trusted financial data providers that offer real-time and historical market data with high accuracy."
    },
    {
      question: "Can you build custom financial dashboards?",
      answer: "Yes, we create custom financial dashboards and analysis tools tailored to your specific requirements."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-right"className="lg:pl-16">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Access real-time financial market data with Yahoo Finance, Quandl, and Alpha Vantage integration. Our experts build financial analysis solutions for informed decision making.
              </p>
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  <div className="relative">
                    {/* Large Finance Icon with gradient background */}
                    <div className="bg-gradient-to-br from-purple-100 to-indigo-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaChartLine className="text-9xl text-[#720e9e]" />
                    </div>
                  </div>
                  ...
                  <div className="absolute -top-10 -right-10 bg-white p-4 rounded-full shadow-lg animate-bounce delay-100">
                    <FaChartBar className="text-3xl text-[#4285F4]" />
                  </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#fb9c24] to-[#ff8c00] relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Access Financial Data?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Partner with us to integrate financial market data into your applications and analysis tools.
          </p>
          <button
            onClick={openForm}
