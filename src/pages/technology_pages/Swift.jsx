...
import { 
  FaApple, FaCode, FaRocket, FaShieldAlt, FaMobileAlt, FaLaptop,
  ...
  const faqs = [
    {
      ...
      answer: "Swift is Apple's modern programming language for iOS, macOS, watchOS, and tvOS development."
    },
    {
      question: "Why use Swift?",
      answer: "Swift offers safety, performance, expressiveness, and modern language features that make development faster and more reliable."
    },
    {
      question: "Is Swift suitable for beginners?",
      answer: "Yes, Swift has a clean syntax and is designed to be easy to learn while still being powerful for advanced developers."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* Swift Logo Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large Swift Icon with gradient background */}
                    <div className="bg-gradient-to-br from-orange-100 to-red-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <SiSwift className="text-9xl text-[#fa7343]" />
                    </div>
                  </div>
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-white p-4 rounded-full shadow-lg animate-bounce delay-300">
                    <FaLaptop className="text-3xl text-[#8B5CF6]" />
                  </div>
                </div>
              </div>
            </div>
