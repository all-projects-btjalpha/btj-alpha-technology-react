  ...
  const faqs = [
    {
      ...
      answer: "CSS3 is the latest evolution of Cascading Style Sheets with advanced features like animations, gradients, shadows, and responsive design capabilities."
    },
    {
      question: "Why use CSS3?",
      answer: "CSS3 offers enhanced visual effects, better performance, improved user experience, and responsive design capabilities."
    },
    {
      question: "Is CSS3 compatible with all browsers?",
      answer: "CSS3 has excellent support across modern browsers, though some features may require vendor prefixes for older browsers."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* CSS3 Logo Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large CSS3 Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaCss3Alt className="text-9xl text-[#1572b6]" />
                    </div>
                  </div>
