...
import { 
  FaDatabase, FaCode, FaShieldAlt, FaLayerGroup, FaServer, FaTools,
  FaCheckCircle, FaChevronDown, FaChevronUp, FaClock, FaUsers,
  FaLaptop, FaSync, FaChartLine, FaCogs, FaRocket, FaMobileAlt
} from "react-icons/fa";
  ...
  const faqs = [
    {
      ...
      answer: "PostgreSQL is a powerful, open-source object-relational database system with over 30 years of active development."
    },
    {
      question: "Why use PostgreSQL?",
      answer: "PostgreSQL offers advanced features, extensibility, standards compliance, and strong data integrity guarantees."
    },
    {
      question: "Is PostgreSQL suitable for large applications?",
      answer: "Yes, PostgreSQL is highly scalable and suitable for large, complex applications with demanding requirements."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-right">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Build enterprise-grade databases with PostgreSQL. Our team creates robust, scalable, and feature-rich database solutions using PostgreSQL's advanced capabilities.
              </p>
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  <div className="relative">
                    {/* Large PostgreSQL Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <SiPostgresql className="text-9xl text-[#336791]" />
                    </div>
                  </div>
