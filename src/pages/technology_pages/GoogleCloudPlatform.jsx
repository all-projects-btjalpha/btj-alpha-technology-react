...
function GoogleCloudPlatform() {
  ...
  const gcpFeatures = [
    ...
    },
    {
      ...
      description: "Advanced security with Google's infrastructure and compliance certifications."
    },
    {
  ...
  const faqs = [
    {
      ...
      answer: "Google Cloud Platform (GCP) is Google's cloud computing platform offering computing, storage, networking, and AI services with innovative technology and global infrastructure."
    },
    {
      question: "Why choose Google Cloud?",
      answer: "GCP offers innovative technology, competitive pricing, strong AI/ML capabilities, excellent performance, and seamless integration with Google services."
    },
    {
      question: "Is Google Cloud secure?",
      answer: "Yes, Google Cloud provides enterprise-grade security with Google's infrastructure, encryption, and compliance certifications."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-right">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
               Best Google Cloud Provider in India– Secure  <br />
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* Google Cloud Logo Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large Google Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaGoogle className="text-9xl text-[#4285f4]" />
                    </div>
                  </div>
                  ...
                  <div className="absolute -top-10 -right-10 bg-white p-4 rounded-full shadow-lg animate-bounce delay-100">
                    <FaRocket className="text-3xl text-[#34a853]" />
                  </div>
