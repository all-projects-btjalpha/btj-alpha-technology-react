...
function KitBuilder() {
  ...
  const whyChooseUs = [
    {
      ...
      title: "Kit Builder Experts",
      description: "Specialists with extensive experience in UI kit and component library development."
    },
    {
      icon: <FaChartLine className="text-5xl text-[#10B981]" />,
  ...
  const faqs = [
    {
      question: "What is Kit Builder?",
      answer: "Kit Builder is a comprehensive UI component library and development toolkit that provides pre-built components, templates, and design systems for rapid application development."
    },
    {
      question: "Why use Kit Builder components?",
      answer: "Kit Builder offers pre-built, customizable UI components that accelerate development, ensure design consistency, and reduce time-to-market for applications."
    },
    {
      question: "Which platforms does Kit Builder support?",
      answer: "Kit Builder supports web applications, mobile apps, and desktop applications with cross-platform compatibility and framework integration."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* Kit Builder Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large Box Icon with gradient background */}
                    <div className="bg-gradient-to-br from-orange-100 to-red-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaBox className="text-9xl text-[#ff6b35]" />
                    </div>
                  </div>

                  {/* Floating Icons */}
                  <div className="absolute -top-10 -left-10 bg-white p-4 rounded-full shadow-lg animate-bounce">
                    <FaCogs className="text-3xl text-[#fb9c24]" />
                  </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#fb9c24] to-[#ff8c00] relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Build with Kit Builder?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Partner with us to leverage the power of Kit Builder for your application development.
          </p>
          <button
            onClick={openForm}
