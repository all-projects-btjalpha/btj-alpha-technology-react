...
function GoogleAPI() {
  ...
  const faqs = [
    {
      question: "What Google APIs do you work with?",
      answer: "We specialize in Google Maps, Analytics, Cloud Platform, Firebase, and various Google Workspace APIs."
    },
    {
      question: "How long does Google API integration take?",
      answer: "Basic API integration typically takes 2-3 weeks, depending on complexity and requirements."
    },
    {
      question: "Do you handle Google API quotas and limits?",
      answer: "Yes, we implement proper quota management and optimization strategies for efficient API usage."
    }
  ];
              ...
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -top-10 -right-10 bg-white p-4 rounded-full shadow-lg animate-bounce delay-100">
                    <FaChartLine className="text-3xl text-[#34a853]" />
                  </div>
