...
function DevExpress() {
  ...
  const faqs = [
    {
      question: "What is DevExpress?",
      answer: "DevExpress is a comprehensive suite of UI components and development tools for building modern web and desktop applications."
    },
    {
      question: "Why use DevExpress components?",
      answer: "DevExpress offers pre-built, customizable UI components that accelerate development and ensure consistent, professional user interfaces."
    },
    {
      question: "Which platforms does DevExpress support?",
      answer: "DevExpress supports web applications (.NET, JavaScript), desktop applications (WinForms, WPF), and mobile development."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
                {/* DevExpress Logo Illustration */}
                <div className="relative">
                  <div className="relative">
                    {/* Large DevExpress Icon with gradient background */}
                    <div className="bg-gradient-to-br from-blue-100 to-cyan-200 rounded-3xl w-80 h-80 flex items-center justify-center shadow-2xl transform hover:scale-105 transition-all">
                      <FaCode className="text-9xl text-[#007acc]" />
                    </div>
                  </div>
