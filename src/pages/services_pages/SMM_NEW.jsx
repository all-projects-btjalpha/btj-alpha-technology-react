...
function SocialMediaMarketing() {
  ...
  return (
    <main className="bg-gradient-to-b from-gray-50 to-white">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                {[
                  ...
                  <div
                    ...
                    className="group bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 hover:border-[#fb9c24] transition-all duration-300 hover:-translate-y-1"
                  >
                    <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#fb9c24] to-[#ff8c00] mb-2">
                      {stat.value}
                    </p>
      ...
      <section className="py-20 px-6 max-md:px-4 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#fb9c24] to-[#ff8c00] px-4 py-2 rounded-full mb-6 shadow-lg">
              <span className="text-xs font-bold text-white tracking-[0.2em] uppercase">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {smmServices.map((service, index) => (
              <div
                ...
                data-aos="fade-up"
                data-aos-delay={index * 100}
                className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-[#fb9c24] hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center"
              >
                <div className="w-28 h-28 bg-white/10 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <img
                    src={service.image}
                    alt={service.title}
                ...
                <h3 className="text-xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[#fb9c24] group-hover:to-[#ff8c00] transition-all duration-300">
                  {service.title}
                </h3>
                <div className="w-16 h-1 bg-gradient-to-r from-[#fb9c24] to-[#ff8c00] rounded-full mb-4"></div>
